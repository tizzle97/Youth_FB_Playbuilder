  ...
  return (
    <div className="relative bg-board overflow-hidden">
        ...
        <div className="relative z-10 pb-8 bg-transparent sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
          ...
          <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
            <div className="sm:text-center lg:text-left">
              ...
              <p className="mt-3 text-base text-chalk/70 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
      ...
      <div className="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
        <div className="h-56 w-full sm:h-72 md:h-96 lg:w-full lg:h-full bg-board-light border-l border-chalk/10 relative">
          <img
            className="w-full h-full object-cover opacity-60 mix-blend-luminosity grayscale"
            src="https://images.pexels.com/photos/2570139/pexels-photo-2570139.jpeg"
            alt="Football chalkboard with plays"
          />
          <div className="absolute inset-0 bg-gradient-to-r from-board via-transparent to-transparent lg:hidden"></div>
        </div>
      </div>
    </div>
  );
